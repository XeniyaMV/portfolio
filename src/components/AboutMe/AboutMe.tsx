      ...
      <article className="about-me__description">
        ...
        <ScrollObserver>
          <p className="about-me__paragraph">
            ...
            progressed to the point where I can design projects, break them down into tasks, and write tests. I am a
            fast learner, always striving to write clean code and improve my skills.
          </p>
        </ScrollObserver>
        <ScrollObserver>
          <p className="about-me__paragraph">
            In addition to my technical skills, I have valuable experience as a team leader. I successfully led a team
            in the final project of one of my courses, where I played a key role in coordinating tasks, ensuring
            effective communication, and delivering a high-quality project. This experience strengthened my ability to
            work collaboratively and reinforced the importance of effective teamwork in achieving project goals.
          </p>
        </ScrollObserver>
      </article>
